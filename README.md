...
这是一个基于Vue.js开发的问卷管理系统，提供问卷的创建、编辑、发布和数据收集等功能。

## 功能特性

- 问卷列表：查看所有问卷，支持按标题、状态筛选
- 问卷创建：支持创建新问卷，添加多种题型（单选题、多选题、填空题）
- 问卷编辑：编辑已有问卷的内容和设置
- 实时预览：编辑问卷时可以实时查看效果
- 问卷发布/下线：控制问卷的可见性和可用性
- 答卷统计：查看每份问卷的答卷数量
...
列表页面展示所有问卷，包含问卷标题、答卷数量、发布状态、创建时间、更新时间等信息。
...
编辑页面采用左右分栏的布局：
- 左侧：问卷编辑区，支持设置问卷基本信息、添加题目、编辑选项等
- 右侧：实时预览区，实时展示问卷填写效果

支持的功能：
- 设置问卷基本信息：标题、描述、截止时间、是否匿名
- 添加题目：支持单选题、多选题、填空题
- 编辑题目选项
- 设置是否必填
- 实时预览问卷效果
...
独立的预览填写页面，用于测试问卷填写体验，支持表单验证和提交。
