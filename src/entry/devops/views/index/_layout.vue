...
import Admin from '@/entry/devops/layout/admin/index.vue'
...
export default class Index extends Vue {
    ...
    handlePasswordEdit() {
        this.$modalDialog(() => import(/* webpackChunkName: "UserPasswordDialog" */ '@/entry/devops/components/UserPasswordDialog/index.vue')).then(() => {
            setTimeout(() => {
                this.logOut()
            }, 1000)
        })
