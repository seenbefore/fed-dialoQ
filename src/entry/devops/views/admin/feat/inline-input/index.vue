<template>
    <div class="sg-page AdminFeatInlineInput">
        <demo-block>
...
import InlineInputReadme from '@/components/inline-input/readme.md'
...
@Component({
    ...
    components: { InlineInputReadme },
})
export default class AdminFeatInlineInput extends Vue {
    examples = examples
