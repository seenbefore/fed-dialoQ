<template>
    <van-field :rows="rows" :maxlength="maxlength" :show-word-limit="showWordLimit" autosize type="textarea" class="my-input" :value="myValue" v-bind="$attrs" @input="input">
...
export default class MyInput extends UseGenerate {
    /**当前输入的值 */
