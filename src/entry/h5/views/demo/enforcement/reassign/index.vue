<template>
    <div class="enforcement-reassign">
        <div class="content">
...
import { mockSubmitReassign } from './api'

@Component({
    name: 'EnforcementReassign',
})
export default class EnforcementReassign extends Vue {
    private formRef: any = null
    private submitting = false

    private formData = {
        handleDepartment: '', // 处置部门
        handleNote: '', // 处置意见
