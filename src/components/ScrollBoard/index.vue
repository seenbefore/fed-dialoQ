    ...
    <div class="dv-scroll-board" :ref="ref">
        ...
        `
            ...
            >
                ...
                >
                    <template v-if="mergedConfig.colRender[ci]">
                        <ExSlot :render="mergedConfig.colRender[ci]" :row="row.ceils" :index="row.rowIndex"></ExSlot>
                    </template>
                    <template v-else>
                        <div v-html="ceil"></div>
                    </template>
...
const ExSlot = {
    ...
    render: (h, ctx) => {
        ...
        const result = ctx.props.render(h, params)
...
export default {
    ...
    methods: {
        ...
        calcData() {
            ...
            this.$emit('scroll', this.rowsData[0], 0)
            animation(true)
        },
        mergeConfig() {
        ...
        async animation(start = false) {
            ...
            if (start) {
                // 第一次滚动
                //console.log(222, animationIndex, this.rowsData[animationIndex])
            ...
            // 滚动后
            this.$emit('scroll', this.rowsData[animationIndex], animationIndex)
